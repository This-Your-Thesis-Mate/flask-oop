...
class AzureOpenAIClient:
    """Client for Azure OpenAI Chat Completion with Vision Support"""
...
# Legacy Sumopod Client (commented out, kept for reference)
# class SumopodClient:
...
# Legacy Groq Client (commented out, kept for reference)
# class GroqClient:
#     """Client for Groq AI"""
#     
#     def __init__(self):
...
# Legacy Groq client reference (now uses Azure OpenAI)
groq_client = azure_openai_client  # Backward compatibility alias
