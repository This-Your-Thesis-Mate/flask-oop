...
class AnnotationService:
    ...
    @staticmethod
    def generate_annotations(course_id, ref_module_id, siteidentifier):
        """
        ...
        try:
            # 1. Get module
            module = module_repository.get_module(course_id, ref_module_id, siteidentifier)
            if not module:
            ...
            chunks_data = chunk_repository.get_chunks_by_module(internal_module_id, siteidentifier)
            if not chunks_data:
            ...
            annotation_repository.delete_annotations(internal_module_id, siteidentifier)

            annotation_repository.create_annotations(internal_module_id, annotations, siteidentifier)
    ...
    @staticmethod
    def get_annotations(course_id, ref_module_id, siteidentifier):
        """
        ...
        try:
            ...
            # 2. Get annotations
            annotations_data = annotation_repository.get_annotations(internal_module_id, siteidentifier)
    ...
    @staticmethod
    def get_annotations_list(course_id=None, modul_id=None, siteidentifier=None):
        """
        ...
        Args:
            ...
            siteidentifier: Site Identifier (required)
        
        Behavior:
            - If only siteidentifier: return list of courses
            - If siteidentifier + course_id: return list of modules in that course
            - If siteidentifier + course_id + modul_id: return specific module with annotations
        
        Returns:
            dict: List of courses, modules, or module details with annotations
        """
        try:
            # Case 1: Only siteidentifier - show list of courses
            if not course_id and not modul_id:
                courses_data = module_repository.get_courses_by_site(siteidentifier)
                ...
                for course in courses_data:
                    ...
                    modules_count_data = module_repository.get_modules_by_course(course_id_val, siteidentifier)
            ...
            # Case 2: siteidentifier + course_id (no modul_id) - show list of modules in course
            elif course_id and not modul_id:
                modules_data = module_repository.get_modules_by_course(course_id, siteidentifier)
                ...
                for module in modules_data:
                    ...
                    annotations_data = annotation_repository.get_annotations(module_id, siteidentifier)
            ...
            # Case 3: siteidentifier + course_id + modul_id - show module with annotations
            else:
                module = module_repository.get_module_by_ref_id(modul_id, siteidentifier, course_id)
                if not module:
                    return {
                        "status": "success",
                        "data": [],
